...
const PaymentMethodButton = ({
  ...
  >
    <div className="flex items-center gap-3">
      {selectedMethod === method && (
        <div className="absolute -top-2 -right-2 bg-pink-600 rounded-full p-1 shadow-md">
    ...
    <ChevronRight
      ...
      className={`text-gray-400 ${
        selectedMethod === method ? "text-pink-500" : ""
      }`}
    />
  </button>
);
  ...
  return (
    <div className="w-full">
      <div className="relative">
        ...
        <div
          className="absolute top-3 left-0 h-1 bg-gradient-to-r from-pink-500 to-purple-500 z-10 transition-all duration-500"
          style={{
          ...
          <div className="sm:h-full relative">
            {order.referenceImages && order.referenceImages[0] ? (
              <div className="md:h-full relative">
                ...
                />
                {/* Added semi-transparent overlay to improve status pill visibility */}
                <div className="absolute inset-0 bg-gradient-to-b from-black/50 to-transparent h-16"></div>
                <div className="absolute top-3 left-3 z-10">
                  <StatusPill status={order.status} />
                </div>
              </div>
            ) : (
              <div className="w-full md:w-1/3 lg:w-1/4 relative bg-gray-100 flex items-center justify-center aspect-square md:h-full">
        ...
        <div className="flex-1 p-3 sm:p-4 md:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <Button
              ...
              className="bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 w-full sm:w-auto"
            >
              <Eye size={16} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-6">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <div className="bg-pink-100 p-2 rounded-lg flex-shrink-0">
                <Shirt size={18} className="text-pink-600" />
              </div>
          ...
          {order.status === "accepted" && (
            <div className="mt-4 p-3 md:p-4 bg-green-50 rounded-lg border border-green-100">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
...
const OrderSkeletonCard = () => (
  <div className="bg-white rounded-xl shadow overflow-hidden border border-gray-200 animate-pulse">
    <div className="flex flex-col md:flex-row">
      {/* Left column with image skeleton */}
      <div className="md:w-1/3 lg:w-1/4 h-64 md:h-auto bg-gray-200"></div>

      {/* Right column with content skeleton */}
      <div className="flex-1 p-6">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between mb-4">
            ...
            <div className="h-10 w-28 bg-gray-200 rounded-lg mt-4 sm:mt-0"></div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              ...
              >
                <div className="bg-gray-200 p-2 rounded-lg h-8 w-8"></div>
...
const Modal = ({ children, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4 md:p-6 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl border border-gray-200 m-auto">
        {children}
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-300 to-pink-100">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl border border-gray-100">
            <div className="max-w-md mx-auto">
              <div className="bg-pink-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Shirt size={32} className="text-pink-600" />
              </div>
              ...
              <Button
                ...
                className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-medium px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all"
              >
                Create Custom Order
              </Button>
            </div>
        ...
        {isModalOpen &&
          ...
          !isPaymentModalOpen && (
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
              <div className="p-4 sm:p-5 md:p-6 border-b flex justify-between items-center bg-gradient-to-r from-pink-50 to-purple-50">
                <div>
              ...
              <div className="p-4 sm:p-5 md:p-6 border-t bg-gray-50">
                <div className="flex justify-between">
                  <Button
                    variant="outline"
                    onClick={() => setIsModalOpen(false)}
        ...
        {isModalOpen && selectedOrder && isAcceptingBid && (
          <Modal isOpen={isModalOpen} onClose={() => setIsAcceptingBid(false)}>
            <div className="p-4 sm:p-5 md:p-6 border-b flex justify-between items-center bg-gradient-to-r from-pink-50 to-purple-50">
              <div>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                          placeholder="House No., Building Name"
                          required
                        />
                        <MapPin
                          className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-pink-500"
                          size={18}
                        />
                      </div>
                    </div>
            ...
            <div className="p-4 sm:p-5 md:p-6 border-t bg-gray-50">
              <div className="flex justify-between">
                ...
                <Button
                  className="bg-pink-600 hover:bg-pink-700 min-w-[180px]"
